                    ...
                    children: [
                      Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[Text(mReviewModel[index].rating.toString(), style: primaryTextStyle(color: whiteColor, size: 12)), 4.width, Icon(Icons.star_border, size: 14, color: whiteColor)],
                        ),
                      ),
                      8.width,
                      Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          4.width,
                          PriceWidget(price: product[i].regularPrice.toString(), size: 12, isLineThroughEnabled: true, color: Theme.of(context).textTheme.subtitle2!.color).visible(product[i].salePrice.toString().isNotEmpty),
                        ],
                      ),
                    ],
                  ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                product[i].onSale!
                                    ? Row(
                                        children: [
                                          PriceWidget(price: product[i].salePrice.toString().validate().isNotEmpty ? product[i].salePrice.toString() : product[i].price.toString().validate(), size: 16),
                                          2.width,
              ...
              children: [
                PageView(
                  children: productImg1.map((i) {
                    return commonCacheImageWidget(i.validate(), fit: BoxFit.cover, height: 400, width: double.infinity).cornerRadiusWithClipRRectOnly(topLeft: 20, topRight: 20).paddingOnly(bottom: 24).onTap(() {
                ...
                AnimatedPositioned(duration: Duration(seconds: 1), bottom: 0, left: 0, right: 0, child: DotIndicator(pages: productImg1, indicatorColor: primaryColor, pageController: _pageController)),
              ],
            ),
          )
        : SizedBox();
        ...
        ? Observer(builder: (context) {
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Text(wishListStore.isItemInWishlist(productDetailNew!.id!) == false ? appLocalization!.translate('lbl_wish_list')!.toUpperCase() : appLocalization!.translate('lbl_wishlisted')!.toUpperCase(),
        ...
        ? GestureDetector(
            ...
            child: Container(
              ...
              decoration: boxDecorationWithRoundedCorners(
                  ...
                  backgroundColor: productDetailNew!.inStock! ? (cartStore.isItemInCart(productDetailNew!.id.validate()) ? Theme.of(context).cardTheme.color! : primaryColor!) : textSecondaryColorGlobal.withOpacity(0.3),
              ...
              ? Row(
                  children: [
                    PriceWidget(
                        ...
                        size: 18),
                    PriceWidget(price: double.parse(productDetailNew!.regularPrice.toString()).toStringAsFixed(2), size: 14, color: Theme.of(context).textTheme.subtitle1!.color, isLineThroughEnabled: true)
    ...
    Widget mSavePrice() {
      if (productDetailNew != null) {
        if (productDetailNew!.onSale!) {
          ...
          if (value > 0) {
            return Row(
              children: [Text(appLocalization!.translate('lbl_you_saved')! + " ", style: secondaryTextStyle(size: 16, color: Colors.green)), PriceWidget(price: value.toStringAsFixed(2), size: 18, color: Colors.green)],
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (productDetailNew!.store != null)
                        Divider(thickness: 6, color: appStore.isDarkMode! ? white.withOpacity(0.2) : Theme.of(context).textTheme.headline4!.color).visible(productDetailNew!.store!.shopName.validate().isNotEmpty),
                      if (productDetailNew!.store != null)
                        Row(
                          children: [
                            Text(appLocalization!.translate('lbl_sold_by')!, style: primaryTextStyle(size: 14, color: Theme.of(context).textTheme.subtitle1!.color)).visible(productDetailNew!.store!.shopName.validate().isNotEmpty),
                            8.width,
                      ...
                      Divider(thickness: 6, color: appStore.isDarkMode! ? white.withOpacity(0.2) : Theme.of(context).textTheme.headline4!.color).visible(productDetailNew!.onSale! && productDetailNew!.dateOnSaleFrom!.isNotEmpty),
                      ...
                      Divider(thickness: 6, color: appStore.isDarkMode! ? white.withOpacity(0.2) : Theme.of(context).textTheme.headline4!.color).visible(productDetailNew!.shortDescription.toString().isNotEmpty),
                      Text(appLocalization.translate('lbl_short_description')!, style: boldTextStyle()).paddingOnly(top: 4, left: 16, right: 16).visible(productDetailNew!.shortDescription.toString().isNotEmpty),
                        ...
                        Wrap(
                          children: productDetailNew!.categories!.map((e) {
                            return Container(
                              ...
                              decoration: boxDecorationWithRoundedCorners(borderRadius: radius(8), backgroundColor: appStore.isDarkMode! ? white.withOpacity(0.2) : Theme.of(context).colorScheme.background),
