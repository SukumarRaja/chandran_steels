                        ...
                        if (productDetailNew!.store != null)
                          Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text(appLocalization!.translate('lbl_vendor')!, style: primaryTextStyle(color: Theme.of(context).textTheme.subtitle1!.color)).visible(productDetailNew!.store!.shopName.validate().isNotEmpty),
                                  8.width,
