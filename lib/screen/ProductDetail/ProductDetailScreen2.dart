    ...
    Widget mSavePrice() {
      if (productDetailNew != null) {
        if (productDetailNew!.onSale!) {
          ...
          if (value > 0) {
            return Row(
              children: [Text(appLocalization!.translate('lbl_you_saved')! + " ", style: secondaryTextStyle()), PriceWidget(price: value.toStringAsFixed(2), size: 18, color: Theme.of(context).textTheme.subtitle1!.color)],
