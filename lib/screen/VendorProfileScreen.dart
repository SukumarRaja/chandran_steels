        ...
        ? SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                !mVendorModel!.phone.isEmptyOrNull ? mOption(mVendorModel!.phone != null ? mVendorModel!.phone : '', Theme.of(context).textTheme.subtitle1!.color) : SizedBox(),
                10.height.visible(mVendorModel!.phone == null && mVendorModel!.phone.isEmptyOrNull),
                mOption(addressText.validate(), Theme.of(context).textTheme.subtitle1!.color, maxLine: 3).visible(addressText!.isNotEmpty),
